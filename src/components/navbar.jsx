...
const Navbar = () => {
  ...
  return (
    <motion.div
      ...
      className=" text-sm md:text-[16px]  z-100 md:w-[1200px] mx-auto  rounded-[5px] h-[75px] flex flex-col mt-2 pl-2 pr-2 " style={{}}>


      <div className=" navbar flex items-center justify-between w-full">
        <h1 className=" ">
          <Link onClick={() => { setThh(null) }} className="w-[136px] text-2xl navtext md:text-2xl " to="/movies">
            CINECHAT
          </Link>
        </h1>
        ...
        <div>
          ...
          {!user && (
            <div className="  flex shadow-black shadow-sm  py-1 px-1 space-x-4 rounded-4xl ">
          ...
          {user && <motion.div className="relative flex items-center text-center navtext "
            onMouseEnter={() => { setMenu(true) }} onMouseLeave={() => { setMenu(false) }} >
            <h1 className="navtext  px-3" >{user.username} </h1>
            <button className="">
              ...
              {menu &&
                <motion.div
                  ...
                  className="absolute z-100 top-full w-auto sm:left-[-100%] md:left-[50%] md:-translate-x-[50%] bg-black text-black rounded-md px-2 py-1.5">
                  <h1>
